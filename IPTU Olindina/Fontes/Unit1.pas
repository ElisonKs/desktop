...
begin
    ...
    ClientDataSet1.MoveBy(1);
         ...
         cont3.Caption := ClientDataSet1.FieldByName('NOME_CONTRIBUINTE_CGM').AsString;
    insc3.Caption := ClientDataSet1.FieldByName('INSCRICAO').AsString;
    log3.Caption := ClientDataSet1.FieldByName('ENDERECO_IMOVEL').AsString;
    num3.Caption := ClientDataSet1.FieldByName('NUMERO_IMOVEL').AsString;
    bai3.Caption := ClientDataSet1.FieldByName('BAIRRO_IMOVEL').AsString;
    com3.Caption := ClientDataSet1.FieldByName('COMPLEMENTO_IMOVEL').AsString;
    cid3.Caption := ClientDataSet1.FieldByName('CIDADE_IMOVEL').AsString;
    uf3.Caption := 'BA';
    codpos3.Caption := ClientDataSet1.FieldByName('CEP_CGM').AsString;
    areater3.Caption := ClientDataSet1.FieldByName('VALOR_M2_TERRENO').AsString;
    valorvenalter3.Caption := ClientDataSet1.FieldByName('VALORVENAL').AsString;
    tipoimo3.Caption := ClientDataSet1.FieldByName('TIPCON').AsString;
    venc3.Caption := ClientDataSet1.FieldByName('DATA_VENCIMENTO_COTAUNICA').AsString;
    areacons3.Caption := ClientDataSet1.FieldByName('AREA_UNIDADE').AsString;
    valorvenalpred3.Caption := ClientDataSet1.FieldByName('VALORPREDIAL').AsString;
    valorventotal3.Caption := CurrtoStr(ClientDataSet1.FieldByName('VALORPREDIAL').AsCurrency +
                             ClientDataSet1.FieldByName('VALORVENAL').AsCurrency);
    desc3.Caption := ClientDataSet1.FieldByName('VALOR_DESCONTO_COTAUNICA').AsString;
    valortrib3.Caption := ClientDataSet1.FieldByName('VALOR_IPTU').AsString;
    taxaexp3.Caption := ClientDataSet1.FieldByName('TAXA_EXPEDIENTE_COTAUNICA').AsString;

    ClientDataSet1.MoveBy(1);


         cont4.Caption := ClientDataSet1.FieldByName('NOME_CONTRIBUINTE_CGM').AsString;
    insc4.Caption := ClientDataSet1.FieldByName('INSCRICAO').AsString;
    log4.Caption := ClientDataSet1.FieldByName('ENDERECO_IMOVEL').AsString;
    num4.Caption := ClientDataSet1.FieldByName('NUMERO_IMOVEL').AsString;
    bai4.Caption := ClientDataSet1.FieldByName('BAIRRO_IMOVEL').AsString;
    com4.Caption := ClientDataSet1.FieldByName('COMPLEMENTO_IMOVEL').AsString;
    cid4.Caption := ClientDataSet1.FieldByName('CIDADE_IMOVEL').AsString;
    uf4.Caption := 'BA';
    codpos4.Caption := ClientDataSet1.FieldByName('CEP_CGM').AsString;
    areater4.Caption := ClientDataSet1.FieldByName('VALOR_M2_TERRENO').AsString;
    valorvenalter4.Caption := ClientDataSet1.FieldByName('VALORVENAL').AsString;
    tipoimo4.Caption := ClientDataSet1.FieldByName('TIPCON').AsString;
    venc4.Caption := ClientDataSet1.FieldByName('DATA_VENCIMENTO_COTAUNICA').AsString;
    areacons4.Caption := ClientDataSet1.FieldByName('AREA_UNIDADE').AsString;
    valorvenalpred4.Caption := ClientDataSet1.FieldByName('VALORPREDIAL').AsString;
    valorventotal4.Caption := CurrtoStr(ClientDataSet1.FieldByName('VALORPREDIAL').AsCurrency +
                             ClientDataSet1.FieldByName('VALORVENAL').AsCurrency);
    desc4.Caption := ClientDataSet1.FieldByName('VALOR_DESCONTO_COTAUNICA').AsString;
    valortrib4.Caption := ClientDataSet1.FieldByName('VALOR_IPTU').AsString;
