...
procedure TfrmPadrao_.btnApagarClick(Sender: TObject);
begin
  cdsPadrao.Delete;
...
procedure TfrmPadrao_.btnConfirmarClick(Sender: TObject);
begin
  confirmou := true;
  close;
end;

procedure TfrmPadrao_.btnEditarClick(Sender: TObject);
begin
   executarSQL_filho;
   cdspadrao.Edit;
end;

procedure TfrmPadrao_.btnFecharClick(Sender: TObject);
begin
  Close;
end;

procedure TfrmPadrao_.btnNovoClick(Sender: TObject);
begin
    btnPesquisarClick(Self);
end;

procedure TfrmPadrao_.btnPesquisarClick(Sender: TObject);
begin
  executarSQL;
end;

procedure TfrmPadrao_.dbgdPadraoDblClick(Sender: TObject);
begin
...
procedure TfrmPadrao_.dbgdPadraoTitleClick(Column: TColumn);
begin
  cdsConsulta.IndexFieldNames := Column.FieldName;
end;

procedure TfrmPadrao_.edConsultaChange(Sender: TObject);
begin
...
procedure TfrmPadrao_.executarSQL;
var
  select: String;
begin
...
procedure TfrmPadrao_.executarSQL_filho;
var
  select: String;
begin
  select := 'SELECT ' + self.campos + ' FROM ' + self.tabela;
...
procedure TfrmPadrao_.FormCreate(Sender: TObject);
begin
...
procedure TfrmPadrao_.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if (key = #27) then
    begin
      cdsConsulta.Close;
...
procedure TfrmPadrao_.FormShow(Sender: TObject);
begin
...
function TfrmPadrao_.moverHint(form: TForm): String;
var
  i: Integer;
begin
...
procedure TfrmPadrao_.timerTimer(Sender: TObject);
begin
...
procedure TfrmPadrao_.verificarCamposComboBox;
var
  i: Integer;
begin
