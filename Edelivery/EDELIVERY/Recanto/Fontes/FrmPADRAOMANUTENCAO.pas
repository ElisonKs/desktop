...
type
  TFrmPADRAOMANUTENCAO_ = class(TForm)
...
var
  FrmPADRAOMANUTENCAO_: TFrmPADRAOMANUTENCAO_;
...
procedure TFrmPADRAOMANUTENCAO_.btnFecharClick(Sender: TObject);
begin
  Close;
end;

procedure TFrmPADRAOMANUTENCAO_.btnSalvarClick(Sender: TObject);
begin
  cdsPadrao.Post;
...
procedure TFrmPADRAOMANUTENCAO_.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if (key = #27) then
    begin
...
procedure TFrmPADRAOMANUTENCAO_.FormShow(Sender: TObject);
begin
...
function TFrmPADRAOMANUTENCAO_.moverHint(form: TForm): String;
var
  i: Integer;
begin
...
procedure TFrmPADRAOMANUTENCAO_.timerTimer(Sender: TObject);
begin
