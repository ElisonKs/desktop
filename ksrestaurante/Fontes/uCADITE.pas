...
procedure TCADITE.CarregarCategorias;
begin
       DM.cdsCAT.Close;
       DM.cdsCAT.CommandText := 'select * from categorias';
       DM.cdsCAT.Open;
end;
...
begin
      ...
      begin
           cds_padrao.Close;
           cds_padrao.CommandText := 'select * from itens where id_ite = ' + edID_ITE.Text;
           cds_padrao.Open;
...
begin
     ...
     if dbeDESC_ITE.Text = '' then
         erro := erro + 'Descrição não informada!';
